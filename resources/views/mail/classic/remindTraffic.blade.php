...
<head>
    <meta charset="UTF-8">
    <title>{{$name}}{{__("Traffic usage reminder")}}</title>
    <style type="text/css">
        img {
            max-width: 100%;
        }
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr
                                    ...
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        {!!__("Your traffic has been used :percentage", ["percentage" => "<strong>80</strong>"])!!}%。{{__("In order not to interfere with your use, please arrange your traffic usage wisely")}}。
                                    </td>
                                </tr>
                                <tr
                                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
