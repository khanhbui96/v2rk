...
<head>
    <meta charset="UTF-8">
    <title>{{$name}}{{__("Expiration reminder")}}
    </title>
    <style type="text/css">
        img {
            max-width: 100%;
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr
                                    ...
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        {!! __("Your service will expire in :number hours", ["number" => "<strong>24</strong>"]) !!}。{{__("In order not to affect the use, please renew as soon as possible")}}。{{__("If you have already renewed your subscription, please ignore this email")}}。
                                    </td>
                                </tr>
                                <tr
                                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        ({{__("This email is sent automatically by the system, please do not reply")}})
                                    </td>
                                </tr>
                                <tr
                                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                        ...
                        <tr
                            ...
                            <td class="aligncenter content-block"
                                ...
                                <a href="{{$url}}/#/subscribe"
                                   style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; color: #999; text-decoration: none; margin: 0;">{{__("My subscription")}}</a>
                                |
                                <a href="{{$url}}/#/knowledge"
                                   style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; color: #999; text-decoration: none; margin: 0;">{{__("Tutorials")}}</a>
                            </td>
                        </tr>
                    </table>
                </div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-QHWDRYZLQ3"></script>
<script>
