...
<head>
    <meta charset="UTF-8">
    <title>{{$name}}{{__("Email verification code")}}</title>
    <style type="text/css">
        img {
            max-width: 100%;
        }
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr
                                    ...
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        {{__("Please fill in the following verification code to complete email verification (valid within :number minutes)", ["number"=>5])}}
                                    </td>
                                </tr>
                                <tr
                                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
